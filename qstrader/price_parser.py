...
class PriceParser(object):
    ...
    within qstrader_aux. Due to efficiency and floating point precision limitations,
    ...
    the qstrader_aux system. Numbers should also always be parsed correctly to view.
    ...
    @dispatch(str)
    def parse(x):  # flake8: noqa
        return float(x) * PriceParser.PRICE_MULTIPLIER
